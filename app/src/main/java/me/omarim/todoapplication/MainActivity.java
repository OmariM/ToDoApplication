...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        readItems();
        // initializing the adapter using the items list
...
//        items.add("Second todo item");
    ...
    public void onAddItem(View v) {
        ...
        etNewItem.setText("");
        // display a notification to the user (Toast)
    ...
    private void setupListViewListener() {
        ...
        lvItems.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                // brings up the edit activity with the expectation of a resul
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == RESULT_OK && requestCode == EDIT_REQUEST_CODE) {
            ...
            // update the model with the new item text as the edited position
            itemsAdapter.notifyDataSetChanged();
